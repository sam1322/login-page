...
const Login = () => {
  return (
    ...
    >
      ...
      <div className="text-white rounded-2xl shadow-lg shadow-grey-500 h-[70%] w-[50%] flex flex-col items-center justify-between border-solid border-2 border-orange-300 lg:w-[30%]">
        <div className="w-[70%] flex flex-col items-center">
          ...
          <div className="w-full my-5 py-2 border-solid border-[1px] border-orange-400 rounded-full flex items-center justify-center p-1 text-orange-400 hover:text-white hover:bg-orange-400 cursor-pointer ease-in duration-300">
            Login
          </div>
          <div>Or</div>
          <div className="mt-2 flex items-center  bg-[#4285f4] text-white font-medium rounded-md">
